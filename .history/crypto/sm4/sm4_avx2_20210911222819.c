 ...
 * @LastEditTime : 2021-09-11 22:28:00
...
// void sm4_avx2_ctr_encrypt(const uint8_t * inputb, uint8_t * outputb, int size, const SM4_AVX2_KEY *ks, uint8_t * iv) {
	
// }

void sm4_avx2_ctr_encrypt(const uint8_t *in, uint8_t *out, int size, const SM4_AVX2_KEY *ks, uint8_t * iv) {
	const int *ks = (int *)key->rk;
	__m256i x0, x1, x2, x3, x4;
	__m256i t0, t1, t2, t3, t4;
